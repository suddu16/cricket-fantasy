...
# Check if Owner column exists (added by points_fetcher)
if 'Owner' not in mvp_df.columns:
    print("⚠️  Warning: Owner column not found in MVP data. Run points_fetcher first!")
    mvp_df['Owner'] = 'Unowned'
